appCtrl.controller('MeusChamadosCtrl', function ($scope, $location, $state, $ionicPopup, ChamadoService, ChamadoAPI, FotoUsuarioAPI, ComentarioAPI, $ionicModal) {
        ...
        ChamadoAPI.listPorUsuario(id).then(
            function(response) {
                ...
                if ($scope.chamados.length == 0){
                    $scope.mensagemAviso = 'Não há chamados criados para você.';
                } else {
                    $scope.mensagemAviso = "";
                }
            },
